...
import breakoutstarter.Block;
import breakoutstarter.Levels;
...
public class Game implements ActionListener, KeyListener {
    ...
    public boolean doBlocksExist() {
    	int count = 0;
    	for (Sprite block : sprites) {
